...
The model registry also accepts `claude:sonnet`, `codex:gpt-6-astra`, `codex:gpt-5.6-luna`, and `codex:gpt-5.6-terra` at every selectable effort. They are opt-in families and do not change the default panel above.
